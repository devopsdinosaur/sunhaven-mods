...
[BepInPlugin("devopsdinosaur.sunhaven.no_more_deadlines", "No More Deadlines", "0.0.2")]
public class NoMoreDeadlinesPlugin : BaseUnityPlugin {
	...
	private void Awake() {
		logger = this.Logger;
		logger.LogInfo((object) "devopsdinosaur.sunhaven.no_more_deadlines v0.0.2 loaded.");
